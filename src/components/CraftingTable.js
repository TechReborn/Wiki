	...
	return (
		<div>
			...
			<div class="crafting-container">
				<div class="grid">
					<div class="slot"><div class="item"><McItem slug={finalInput[0].id} pack={finalInput[0].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[1].id} pack={finalInput[1].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[2].id} pack={finalInput[2].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[3].id} pack={finalInput[3].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[4].id} pack={finalInput[4].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[5].id} pack={finalInput[5].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[6].id} pack={finalInput[6].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[7].id} pack={finalInput[7].pack} size="64"/> </div></div>
					<div class="slot"><div class="item"><McItem slug={finalInput[8].id} pack={finalInput[8].pack} size="64"/> </div></div>
				</div>

				<div class="arrow"><img src="/img/crafting_arrow.jpg" width="32" /></div>

				<div class="output-slot">
					<div class="item"><div class="item"><McItem slug={finalOutput.id} pack={finalOutput.pack} size="64"/></div></div>
				</div>
			</div>
		</div>
	);
