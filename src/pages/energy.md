...
At its core, Tech Reborn's energy is very simple. Energy is created by <McItem slug="techreborn:generator" inline={true}/> **[generators](/docs/blocks/generators)**; passed through <McItem slug="techreborn:insulated_copper_cable" inline={true}/> **[cables](/docs/blocks/cables)**; stored in <McItem slug="techreborn:mfe" inline={true}/> **[batteries](/docs/blocks/batteries)**; and consumed by <McItem slug="techreborn:grinder" inline={true}/> **[machines](/docs/blocks/machines)**. Advanced networks may also make use of <McItem slug="techreborn:mv_transformer" inline={true}/> **[transformers](/docs/blocks/transformers)**.

1. <McItem slug="techreborn:generator" inline={true}/> **[generators](/docs/blocks/generators)** produce energy each tick — then they:
...
2. <McItem slug="techreborn:insulated_copper_cable" inline={true}/> **[cables](/docs/blocks/cables)** have an internal buffer (which depends on their tier) — Cables will:
...
3. <McItem slug="techreborn:mfe" inline={true}/> **[batteries](/docs/blocks/batteries)** input energy from up to 5 sources; then they:
   - output energy into any directly connected machine or cable — or if that is full;
   - store the energy in their own storage.
   - <McItem slug="techreborn:grinder" inline={true}/> **[machines](/docs/blocks/machines)**
     - <McItem slug="techreborn:overclocker_upgrade" inline={true}/> **[upgrades](/docs/blocks/machines/upgrades)**
   - <McItem slug="techreborn:mv_transformer" inline={true}/> **[transformers](/docs/blocks/transformers)** input energy at one rate — then they:
...
<img src="/img/docs/blocks/machines/grinder_interface.png" width="512" />
...
<img src="/img/docs/blocks/machines/grinder_io_interface.png" width="580" />
...
<img src="/img/docs/blocks/machines/grinder_redstone_interface.png" width="512" />
...
<img src="/img/docs/blocks/machines/389956634-4523abef-e0c6-45f3-a9db-d6d06ba58471.gif" width="512" />
...
- 1.14 and above use [Energy](https://github.com/TechReborn/docs/blocks)  
