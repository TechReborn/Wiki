...
<Machine config={{input: [{id: "techreborn:brass_dust"}], output: [
...
<Machine config={{input: [{id: "techreborn:brass_dust"}], output: [{id: "techreborn:brass_ingot"}], tool: "techreborn:iron_furnace"}} />
