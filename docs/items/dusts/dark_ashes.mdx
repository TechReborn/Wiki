...
<Machine next={{input: [{id: "minecraft:blaze_powder", qty: 4}], output: [
...
<Machine next={{input: [{id: "techreborn:dark_ashes", qty: 2}], output: [{id: "techreborn:ashes", qty: 2}], tool: "techreborn:industrial_centrifuge"}} />
