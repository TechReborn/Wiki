...
<Machine config={{input: [{id: "minecraft:lapis_lazuli"}], output: [
...
<Machine config={{input: [{id: "techreborn:lazurite_dust", qty: 8}], output: [{id: "techreborn:lazurite_plate"}], tool: "techreborn:compressor"}} />
