...
The `slug` is the name of the file in `/static/imgs/techreborn/` without the file extension. We also use the slug to find the correct page in the index and to render the friendly name of the item.
