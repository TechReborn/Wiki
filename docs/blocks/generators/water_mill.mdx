...
<CraftingTable recipe="input minecraft:stick minecraft:oak_planks minecraft:stick input minecraft:oak_planks techreborn:generator minecraft:oak_planks input minecraft:stick minecraft:oak_planks minecraft:stick output techreborn:water_mill"/>
